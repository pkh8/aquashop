...
import com.shop.aqua.dto.QMainItemDto;
import com.shop.aqua.entity.Item;


import com.shop.aqua.entity.QItem;
import com.shop.aqua.entity.QItemImg;
...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom {
    ...
    private BooleanExpression searchByLike(String searchBy, String searchQuery) {
        ...
        if (StringUtils.equals("itemNm", searchBy)) {
            ...
            return QItem.item.itemCategory.like("%" + searchQuery + "%");
        }
    ...
    public Page<MainItemDto> getCategoryItemPage(ItemSearchDto itemSearchDto, String itemCategory, Pageable pageable) {
        ...
        QueryResults<MainItemDto> results = queryFactory
                ...
                .join(itemImg.item, Item)
                .where(itemImg.repImgYn.eq("Y"))
                .where(Item.itemCategory.like(itemCategory))
                .orderBy(Item.id.desc())
                .offset(pageable.getOffset())
                .limit(pageable.getPageSize())
                .fetchResults();
